  ...
  if (variant === 'filled') {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" role="img" className={cn(className)} {...props}>
            <path fillRule="evenodd" clipRule="evenodd" d="M7.16793 3.94531C7.47429 3.48579 8.09516 3.36161 8.55468 3.66796L16.0547 8.66796C16.3281 8.85026 16.4946 9.15529 16.4999 9.48389C16.5052 9.8125 16.3487 10.1227 16.0812 10.3137L10.2602 14.4716L16.5547 18.668C17.0142 18.9743 17.1384 19.5952 16.832 20.0547C16.5257 20.5142 15.9048 20.6384 15.4453 20.3321L7.94528 15.3321C7.67183 15.1498 7.50541 14.8447 7.50011 14.5161C7.49482 14.1875 7.65132 13.8773 7.91875 13.6863L13.7398 9.5284L7.44528 5.33206C6.98576 5.02571 6.86158 4.40484 7.16793 3.94531Z" fill="currentColor"></path>
            <path d="M15.25 19.5C15.25 17.7051 16.7051 16.25 18.5 16.25C20.2949 16.25 21.75 17.7051 21.75 19.5C21.75 21.2949 20.2949 22.75 18.5 22.75C16.7051 22.75 15.25 21.2949 15.25 19.5Z" fill="currentColor"></path>
