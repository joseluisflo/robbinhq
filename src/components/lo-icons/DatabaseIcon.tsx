...
<path fillRule="evenodd" clipRule="evenodd" d="M3.62747 14.1164C3.3392 13.9608 3.19506 13.883 3.09753 13.9412C3 13.9993 3 14.1584 3 14.4765V18.9998C3 19.8027 3.43749 20.4479 3.96527 20.9158C4.49422 21.3848 5.20256 21.7614 5.99202 22.0575C7.57833 22.6523 9.70269 22.9998 12 22.9998C14.2973 22.9998 16.4217 22.6523 18.008 22.0575C18.7974 21.7614 19.5058 21.3848 20.0347 20.9158C20.5625 20.4479 21 19.8027 21 18.9998V14.4765C21 14.1584 21 13.9993 20.9025 13.9412C20.8049 13.883 20.6608 13.9608 20.3725 14.1164C20.1849 14.2177 19.994 14.3137 19.8008 14.4046C17.5135 15.481 14.6113 15.9998 12 15.9998C9.346 15.9998 6.60931 15.5388 4.1992 14.4046C4.00604 14.3137 3.81512 14.2177 3.62747 14.1164ZM7.21611 17.1257C6.81943 17.0065 6.40119 17.2314 6.28195 17.628C6.1627 18.0247 6.38761 18.443 6.78428 18.5622C7.42389 18.7545 8.1316 18.9106 8.88764 19.0254C9.29716 19.0875 9.67954 18.8059 9.7417 18.3964C9.80387 17.9869 9.52228 17.6045 9.11276 17.5424C8.41746 17.4368 7.77966 17.2951 7.21611 17.1257Z" fill="currentColor"></path>
  ...
  if (variant === 'duotone') {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" role="img" className={cn(className)} {...props}>
            <path opacity="0.4" d="M12 8C16.4183 8 20 6.65685 20 5V19C20 20.6569 16.4183 22 12 22C7.58172 22 4 20.6569 4 19V5C4 6.65685 7.58172 8 12 8Z" fill="currentColor"></path>
            <ellipse cx="12" cy="5" rx="8" ry="3" stroke="currentColor" strokeWidth="2"></ellipse>
            <path d="M7 10.842C7.60158 11.0229 8.27434 11.1718 9 11.282" stroke="currentColor" strokeWidth="2" strokeLinecap="round"></path>
            <path d="M20 12C20 13.6569 16.4183 15 12 15C7.58172 15 4 13.6569 4 12" stroke="currentColor" strokeWidth="2"></path>
            <path d="M7 17.842C7.60158 18.0229 8.27434 18.1718 9 18.282" stroke="currentColor" strokeWidth="2" strokeLinecap="round"></path>
            <path d="M20 5V19C20 20.6569 16.4183 22 12 22C7.58172 22 4 20.6569 4 19V5" stroke="currentColor" strokeWidth="2"></path>
        </svg>
    );
  }
  return (
